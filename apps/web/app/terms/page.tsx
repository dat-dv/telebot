  ...
  return (
    <main className="mx-auto min-h-screen max-w-[860px] bg-slate-50 p-6 text-slate-900 max-[680px]:p-[18px]">
      <header className="flex items-center justify-between gap-[18px] max-[680px]:flex-col max-[680px]:items-start max-[680px]:gap-[14px]">
        <Link className="inline-flex items-center gap-2 text-lg font-extrabold text-slate-900 no-underline" href={APP_ROUTES.about}>
        ...
        <Link className="text-blue-700 no-underline hover:underline" href={APP_ROUTES.privacy}>{t('public.privacy.title')}</Link>
      </header>
