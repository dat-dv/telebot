...
const messages = {
  vi: {
    ...
    'analytics.cashflow.column.netCashflow': 'Dòng tiền thuần',
    'analytics.cashflow.column.balance': 'Số dư tích lũy',
    'calendar.title': 'Lịch',
  ...
  en: {
    ...
    'analytics.cashflow.column.netCashflow': 'Net Cash Flow',
    'analytics.cashflow.column.balance': 'Cumulative Balance',
