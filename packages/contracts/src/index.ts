...
const messages = {
  vi: {
    ...
    'public.about.description': 'Telebot giúp bạn ghi nhận thu chi, theo dõi công nợ, tạo lời nhắc và đồng bộ lịch trình hoặc việc cần làm với Google khi bạn lựa chọn kết nối.',
    ...
    'public.about.financeDescription': 'Ghi nhận thu chi, theo dõi khoản vay và xem lại tổng quan theo thời gian.',
    'public.about.planningTitle': 'Kế hoạch rõ ràng',
    'public.about.planningDescription': 'Tạo nhắc nhở, theo dõi việc cần làm và quản lý lịch trình cá nhân.',
    'public.about.googleTitle': 'Kết nối Google theo lựa chọn',
    'public.about.googleDescription': 'Khi bạn cấp quyền, Telebot dùng Google Calendar và Google Tasks để thực hiện đúng các lệnh bạn yêu cầu.',
    ...
    'public.privacy.intro': 'Telebot tôn trọng quyền riêng tư của bạn. Chính sách này mô tả dữ liệu chúng tôi xử lý, lý do xử lý và các lựa chọn của bạn.',
    'public.privacy.dataTitle': '1. Dữ liệu chúng tôi xử lý',
    'public.privacy.dataDescription': 'Để vận hành bot, Telebot lưu Telegram user ID, dữ liệu tài chính và kế hoạch do bạn nhập, cùng dữ liệu kỹ thuật cần thiết để duy trì dịch vụ.',
    'public.privacy.scopesIntro': 'Khi bạn chủ động kết nối Google, chúng tôi chỉ yêu cầu các quyền sau:',
    'public.privacy.profileScope': 'Thông tin hồ sơ cơ bản và địa chỉ email để nhận diện tài khoản đã kết nối.',
    'public.privacy.calendarScope': 'Google Calendar để đọc, tạo, cập nhật hoặc xóa sự kiện theo lệnh của bạn.',
    'public.privacy.tasksScope': 'Google Tasks để đọc, tạo, cập nhật hoặc hoàn thành việc cần làm theo lệnh của bạn.',
    'public.privacy.useTitle': '2. Cách chúng tôi sử dụng dữ liệu Google',
    'public.privacy.useDescription': 'Dữ liệu Google chỉ được dùng để cung cấp các tính năng Calendar và Tasks mà bạn trực tiếp yêu cầu trong Telebot. Chúng tôi không bán, cho thuê, dùng dữ liệu Google cho quảng cáo, hoặc chuyển dữ liệu đó cho bên thứ ba ngoài nhà cung cấp hạ tầng cần thiết để vận hành dịch vụ.',
    'public.privacy.policyPrefix': 'Việc Telebot sử dụng và chuyển giao dữ liệu nhận từ Google APIs tuân thủ ',
    ...
    'public.privacy.securityDescription': 'Token truy cập Google được mã hóa trước khi lưu trong cơ sở dữ liệu. Chúng tôi áp dụng biện pháp kỹ thuật hợp lý để hạn chế truy cập trái phép; tuy vậy không có phương thức truyền hay lưu trữ dữ liệu nào an toàn tuyệt đối.',
    'public.privacy.retentionTitle': '4. Lưu giữ và xóa dữ liệu',
    'public.privacy.retentionDescription': 'Chúng tôi lưu dữ liệu trong thời gian cần thiết để cung cấp dịch vụ hoặc theo yêu cầu pháp luật. Bạn có thể yêu cầu thu hồi kết nối Google và xóa token/dữ liệu liên quan bằng cách gửi email tới {email} từ địa chỉ email đã kết nối. Chúng tôi sẽ phản hồi yêu cầu trong thời hạn hợp lý.',
    'public.privacy.contactTitle': '5. Liên hệ',
    'public.privacy.contactDescription': 'Nếu có câu hỏi về quyền riêng tư hoặc dữ liệu cá nhân, liên hệ {email}.',
    ...
    'public.terms.acceptanceDescription': 'Bằng việc sử dụng Telebot, bạn đồng ý với các điều khoản này và Chính sách quyền riêng tư. Nếu không đồng ý, vui lòng không sử dụng dịch vụ.',
    'public.terms.scopeTitle': '2. Phạm vi dịch vụ',
    'public.terms.scopeDescription': 'Telebot là công cụ hỗ trợ quản lý thông tin cá nhân, tài chính, lịch trình và việc cần làm. Dịch vụ không cung cấp tư vấn tài chính, pháp lý hoặc đầu tư chuyên nghiệp.',
    'public.terms.accountTitle': '3. Tài khoản và quyền truy cập',
    'public.terms.accountDescription': 'Bạn chịu trách nhiệm với các lệnh được gửi từ tài khoản Telegram của mình. Kết nối Google là tự nguyện và có thể được thu hồi theo hướng dẫn tại Chính sách quyền riêng tư.',
    'public.terms.legalTitle': '4. Sử dụng hợp pháp',
    'public.terms.legalDescription': 'Bạn không được sử dụng Telebot để vi phạm pháp luật, xâm phạm quyền của người khác, can thiệp trái phép vào dịch vụ hoặc gây ảnh hưởng đến hoạt động của hệ thống.',
    'public.terms.changeTitle': '5. Thay đổi dịch vụ',
    'public.terms.changeDescription': 'Chúng tôi có thể cập nhật dịch vụ hoặc điều khoản khi cần thiết. Phiên bản mới sẽ được công bố trên trang này.',
  ...
  en: {
    ...
    'public.about.description': 'Telebot helps you record income and expenses, track debts, create reminders, and sync your calendar or tasks with Google when you choose to connect.',
    ...
    'public.about.financeDescription': 'Record income and expenses, track loans, and review your overview over time.',
    'public.about.planningTitle': 'Clear planning',
    'public.about.planningDescription': 'Create reminders, track tasks, and manage your personal schedule.',
    'public.about.googleTitle': 'Google connection by choice',
    'public.about.googleDescription': 'When you grant permission, Telebot uses Google Calendar and Google Tasks only to perform the actions you request.',
    'public.about.copyright': '© {year} Telebot',
    'public.about.support': 'Support: {email}',
    'public.about.privacyPolicy': 'Privacy Policy',
    'public.about.termsOfService': 'Terms of Service',
    'public.privacy.title': 'Privacy Policy',
    'public.privacy.intro': 'Telebot respects your privacy. This policy explains the data we process, why we process it, and your choices.',
    'public.privacy.dataTitle': '1. Data we process',
    'public.privacy.dataDescription': 'To operate the bot, Telebot stores your Telegram user ID, finance and planning data you enter, and technical data required to run the service.',
    'public.privacy.scopesIntro': 'When you choose to connect Google, we request only the following permissions:',
    'public.privacy.profileScope': 'Basic profile information and email address to identify the connected account.',
    'public.privacy.calendarScope': 'Google Calendar to read, create, update, or delete events that you request.',
    'public.privacy.tasksScope': 'Google Tasks to read, create, update, or complete tasks that you request.',
    'public.privacy.useTitle': '2. How we use Google data',
    'public.privacy.useDescription': 'Google data is used only to provide the Calendar and Tasks features you directly request in Telebot. We do not sell, rent, use Google data for advertising, or transfer it to third parties except infrastructure providers required to operate the service.',
    'public.privacy.policyPrefix': 'Telebot’s use and transfer of information received from Google APIs adheres to the ',
    'public.privacy.policyLink': 'Google API Services User Data Policy',
    'public.privacy.policySuffix': ', including the Limited Use requirements.',
    'public.privacy.securityTitle': '3. Storage and security',
    'public.privacy.securityDescription': 'Google access tokens are encrypted before storage in the database. We use reasonable technical measures to limit unauthorized access; however, no transmission or storage method is completely secure.',
    'public.privacy.retentionTitle': '4. Retention and deletion',
    'public.privacy.retentionDescription': 'We retain data for as long as needed to provide the service or as required by law. You may request that we revoke your Google connection and delete related token/data by emailing {email} from the connected email address. We will respond within a reasonable period.',
    'public.privacy.contactTitle': '5. Contact',
    'public.privacy.contactDescription': 'For questions about privacy or personal data, contact {email}.',
    'public.privacy.about': 'About Telebot',
    'public.terms.title': 'Terms of Service',
    'public.terms.acceptanceTitle': '1. Acceptance',
    'public.terms.acceptanceDescription': 'By using Telebot, you agree to these terms and the Privacy Policy. If you do not agree, please do not use the service.',
    'public.terms.scopeTitle': '2. Service scope',
    'public.terms.scopeDescription': 'Telebot is a tool for managing personal information, finances, schedules, and tasks. It does not provide professional financial, legal, or investment advice.',
    'public.terms.accountTitle': '3. Account and access',
    'public.terms.accountDescription': 'You are responsible for commands sent from your Telegram account. Connecting Google is optional and can be revoked as described in the Privacy Policy.',
    'public.terms.legalTitle': '4. Lawful use',
    'public.terms.legalDescription': 'You may not use Telebot to violate the law, infringe others’ rights, interfere with the service, or harm system operations.',
    'public.terms.changeTitle': '5. Service changes',
    'public.terms.changeDescription': 'We may update the service or these terms when necessary. The latest version will be published on this page.',
