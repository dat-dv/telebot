...
- UI: Xây dựng 100% bằng Tailwind CSS utility classes (hỗ trợ dark mode `dark:`). Hiển thị danh sách lời nhắc gồm nội dung, thời gian nhắc, trạng thái, badge loại thông báo và chi tiết bổ sung.
