...
- Trang Báo cáo & Phân tích trực quan (`/analytics` - `AnalyticsScreen`):
  ...
  - Dải thẻ chỉ số KPI: Tổng Thu, Tổng Chi, Tiết Kiệm Ròng, Tỷ Lệ Tích Lũy (%), và Chênh Lệch Vay Nợ với màu sắc ngữ nghĩa (xanh/vàng/đỏ) và số liệu dạng `tabular-nums`.
