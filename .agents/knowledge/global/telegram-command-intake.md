...
Direct command handlers must remain independently testable. The fallback harness verifies `/start` and `/help` still reply when dashboard-link issuance fails.
