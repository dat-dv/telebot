...
The shared `/start` and `/help` inline menu exposes **Xem báo cáo** as that URL directly. The legacy callback remains only for already-sent menus and issues a new URL before replying.
