...
2. **Exception Mapping**:
   ...
   - `QueryFailedError` (TypeORM PostgreSQL constraint errors such as `23505`): Maps to `409 Conflict` or `400 Bad Request` instead of leaking internal database errors.
