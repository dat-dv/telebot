...
- **Web UI & Hierarchical Tree**: `DebtsTable` supports multi-select checkboxes for batch combining, an expandable tree view (`▶ / ▼`) showing indented child debts (`[Khoản con]`), and parent badges (`[Gộp: N khoản con]`).
