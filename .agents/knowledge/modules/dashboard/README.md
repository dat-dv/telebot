...
The Analytics screen (`AnalyticsScreen`) provides a dedicated visual reporting dashboard combining:
...
- **KPI Summary Strip**: 5 quick-scan cards for Total Income, Total Expense, Net Savings, Savings Rate (%), and Net Debt with positive/warning/negative semantic coloring and tabular numbers (`tabular-nums`).
