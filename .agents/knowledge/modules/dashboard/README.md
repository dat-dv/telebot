...
- **Single-Page Layout**:
  ...
  - **Common UI seam**: analytics KPI groups use the shared `MetricGrid`; all period controls and chart/table controls use the shared `Button`. The Analytics feature contains no raw interactive HTML tags.
