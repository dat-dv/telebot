...
`SessionStateScreen` (`apps/web/src/modules/auth/view/session-state-screen.tsx`) renders the post-logout (`reason="logged_out"`) or session-expired (`reason="expired"`) states. It provides:
