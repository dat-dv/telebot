...
1. **Table Cell-Level Border & Column Width Parity (Đồng bộ viền và độ rộng ô bảng)**:
...
1. **Zero Raw Text Loading Policy (Cấm text loading thô sơ)**:
...
1. **Zero Duplicate / Shifting Headers (Không thêm header thừa)**:
